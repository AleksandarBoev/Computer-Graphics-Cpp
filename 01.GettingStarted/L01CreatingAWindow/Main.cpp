...
int main()
{
	std::cout << "You can control colors!" << std::endl
		...
		<< "Same goes for Num2 and Num5 for green and Num3 and Num6 for blue";
	...
	glViewport(0, 0, startingWidth, startingHeight); //x, y, width, height. x = 0 --> leftmost, y = 0 --> bottom. values are [-1, 1]
